...
namespace vg
{
    ...
    namespace physics
    {
        ...
        struct Callbacks
        {
            using ValidateContact = bool(*)(core::IObject *, core::IObject *);

            ValidateContact validateContact = nullptr;
        };
	    ...
	    public:
            ...
            virtual void                    Init                        (const PhysicsCreationParams & _params, const Callbacks & _callbacks, core::Singletons & _singletons) = 0;
