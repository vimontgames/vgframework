...
vg_enum_class_ns(vg::physics, ObjectLayer, core::u16,
    NonMoving = 0,
    Moving
);
...
vg_enum_class_ns(vg::physics, BPLayer, core::u8,
    NonMoving = 0,
    Moving
);

vg_enum_class_ns(vg::physics, MotionType, core::u8,
    Static = 0, // Non movable
    Kinematic,  // Movable using velocities only, does not respond to forces
    Dynamic     // Responds to forces as a normal physics object
);

vg_enum_class_ns(vg::physics, MotionQuality, core::u8,
    Discrete = 0,   // Update the body in discrete steps
    Continuous      // Update the body using linear casting
);

vg_enum_class_ns(vg::physics, ShapeType, core::u8,
    Sphere = 0,
    Box,
    Capsule,
    Cylinder,
...
vg_enum_class_ns(vg::physics, ShapeTypeFlags, core::u32,
...
vg_enum_class_ns(vg::physics, BodyType, core::u8,
    Rigid = 0,
    Soft
);

vg_enum_class_ns(vg::physics, CharacterType, core::u8,
    Rigid = 0,
    Virtual
);

vg_enum_class_ns(vg::physics, GroundState, core::u8,
