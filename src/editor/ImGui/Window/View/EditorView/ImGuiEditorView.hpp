...
namespace vg::editor
{
    ...
    ImGuiEditorView::ImGuiEditorView(uint _index) :
        ImGuiView(style::icon::EditorView, "View", "Editor", ImGuiWindow::StartVisible | ImGuiWindow::AddMenuEntry, gfx::ViewportTarget::Editor, _index)
    {
    ...
    //--------------------------------------------------------------------------------------
    renderer::ViewFlags ImGuiEditorView::GetViewFlags() const
    {
        return renderer::ViewFlags::Render;  // Editor views don't need a gameplay camera update to render
    }
