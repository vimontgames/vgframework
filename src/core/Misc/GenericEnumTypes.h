...
#define vg_generic_enum_value_64(Namespace, enumTypename) vg_enum_class_ns(Namespace, enumTypename, core::u8,   \
...
#define vg_generic_enum_bitfield_64(Namespace, enumTypename) vg_enum_class_ns(Namespace, enumTypename, core::u64,                                                                                                                                      \
