...
namespace vg::core
{
    #define vg_generic_enum_value_64(enumTypename) vg_enum_class(enumTypename, core::u8,   \
...
#define vg_generic_enum_bitfield_64(enumTypename) vg_enum_class(enumTypename, core::u64,                                                                                                                                      \
