...
vg_enum_class_ns(vg::core, InputType, core::u8,
    Keyboard = 0,
    Mouse,
    Joypad
);

vg_enum_class_ns(vg::core, KeyboardLayout, core::u8,
    Qwerty = 0,
    Azerty
);
...
vg_enum_class_ns(vg::core, MouseButton, core::u8,
    Left = 0,
    Right,
    Middle
);

vg_enum_class_ns(vg::core, JoyButton, core::u8,
    A = 0,
    B,
    X,
    Y,
...
vg_enum_class_ns(vg::core, Key, core::u16,
    Escape = 0,
    One,
    Two,
    Three,
