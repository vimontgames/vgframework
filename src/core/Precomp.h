...
#if defined(VG_RELEASE) || defined(VG_FINAL)
#define VG_OPTIMIZED 
#endif
...
#define VG_ASSERT_IS_ALIGNED(address, alignment) VG_ASSERT(0 == (uint_ptr(address) & (alignment-1)), "%s (0x%016llX) is not aligned to %u bytes", #address, address, alignment)
