...
#define vg_enum_ns(Namespace, Type, UnderlyingType, ...) meta_enum_ns(Namespace, Type, UnderlyingType, __VA_ARGS__) 
#define vg_enum_class_ns(Namespace, Type, UnderlyingType, ...) meta_enum_class_ns(Namespace, Type, UnderlyingType, __VA_ARGS__)
