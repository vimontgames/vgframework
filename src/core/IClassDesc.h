...
namespace vg::core
{
    ...
    public:
        ...
        virtual void                        RegisterProperty            (const char * _className, const char * _propertyName, i64 * _offset, const char * _displayName, IProperty::Flags _flags) = 0;
        ...
        virtual void                        RegisterProperty            (const char * _className, const char * _propertyName, u64 * _offset, const char * _displayName, IProperty::Flags _flags) = 0;
        ...
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, u8 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames,  const u8 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, u16 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const u16 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, u32 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const u32 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, u64 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const u64 * _enumValues, IProperty::Flags _flags) = 0;
        
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, i8 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames,  const i8 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, i16 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const i16 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, i32 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const i32 * _enumValues, IProperty::Flags _flags) = 0;
        virtual void                        RegisterEnum                (const char * _className, const char * _propertyName, const char * _enumTypeName, i64 * _offset, const char * _displayName, uint _enumCount, const char * _enumNames, const i64 * _enumValues, IProperty::Flags _flags) = 0;
