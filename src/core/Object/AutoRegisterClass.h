...
#define VG_REGISTER_ABSTRACT_CLASS(className)                                                       VG_REGISTER_ABSTRACT_CLASS_EX(className, #className, vg::core::ClassDescFlags::Abstract)

#define VG_REGISTER_CLASS_EX(className, displayName, flags)                                         vg::core::AutoRegisterObjectClassHelper<className> autoRegister##className(#className, className::registerClass);                   \
                                                                                                    bool className::registerClass(vg::core::IFactory & _factory)                                                                        \
                                                                                                    {                                                                                                                                   \
...
#define VG_REGISTER_RESOURCE_CLASS(className, displayName, priority)                                vg::core::AutoRegisterObjectClassHelper<className> autoRegister##className(#className, className::registerClass);                   \
                                                                                                    ...
                                                                                                    {                                                                                                                                   \
                                                                                                        ...
                                                                                                        {                                                                                                                               \
                                                                                                            registerProperties(*desc);                                                                                                  \
                                                                                                            desc->SetPriority((vg::core::u16)priority);                                                                                 \
                                                                                                            return true;                                                                                                                \
                                                                                                        }                                                                                                                               \
                                                                                                        return false;                                                                                                                   \
                                                                                                    }
