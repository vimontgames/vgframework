...
namespace vg::core
{
    ...
    public:
        ...
        virtual void                        SetLastModifiedDate     (core::io::FileAccessTime _timestamp) = 0;
        virtual core::io::FileAccessTime    GetLastModifiedDate     () const = 0;
        virtual void                        SetLastCookDate         (core::io::FileAccessTime _timestamp) = 0;
        virtual core::io::FileAccessTime    GetLastCookDate         () const = 0;
    };
}