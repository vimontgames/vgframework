...
namespace vg::gfx
{
    ...
    public:     
        ...
        VG_INLINE const core::vector<IFrameGraphView *> &   getViews            () const;
        VG_INLINE void                                      setViews            (core::vector<IFrameGraphView *> & _views);
    ...
    private:
        ...
        core::vector<IFrameGraphView*>                      m_views;
