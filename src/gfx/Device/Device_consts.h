...
namespace vg::gfx
{
    ...
    vg_enum_class(vg::gfx, Severity, core::u8,
        Error = 0,
        Warning,
        Info,
        Verbose
    ...
    vg_enum_class(vg::gfx, API, core::u8,
        DirectX12,
        Vulkan,
        Metal
    );

    vg_enum_class(vg::gfx, VSync, core::u8,
        None = 0,
        VSync_1,
        VSync_2,
        VSync_3,
    ...
    vg_enum_class(vg::gfx, AAPostProcess, core::u8,
        None = 0,
        FXAA,
        SMAA
    );

    vg_enum_class(vg::gfx, HDR, core::u8,
        None    = 0,
        HDR10   = 1,
        HDR16   = 2
    );

    vg_enum_class(vg::gfx, HDRFlags, core::u8,
        None    = 1 << (core::u8)HDR::None,
        HDR10   = 1 << (core::u8)HDR::HDR10,
        HDR16   = 1 << (core::u8)HDR::HDR16
    );

    vg_enum_class(vg::gfx, ColorSpace, core::u8,
        Rec709 = 0,
        ST2084,
        Rec2020
    );
