...
vg_enum_class_ns(vg::gfx, TextureType, core::u8,
	Texture1D = 0x01,
	Texture2D = 0x02,
	Texture3D = 0x03,
	TextureCube = 0x06,
...
vg_enum_class_ns(vg::gfx, PixelFormat, core::u8,
	Unknow = 0,
	R8G8B8A8_unorm,
	R8G8B8A8_unorm_sRGB,
	B8G8R8A8_unorm,
...
vg_enum_class_ns(vg::gfx, TextureFlags, core::u32,
	None = 0x00000000,
...
vg_enum_class_ns(vg::gfx, MSAA, core::u8,
	None = 0,
	MSAA2X = 1,
	MSAA4X = 2,
	MSAA8X = 3,
...
vg_enum_class_ns(vg::gfx, MSAAFlags, core::u8,
