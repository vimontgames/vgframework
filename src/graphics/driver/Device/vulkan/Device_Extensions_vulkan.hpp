namespace vg::graphics::driver::vulkan
{
	...
	{
		auto & instance = driver::Device::get()->getVulkanInstance();
	...
	PFN_vkVoidFunction Extension::getVulkanDeviceProcAddress(const char * _func)
	{
		...
		auto & device = driver::Device::get()->getVulkanDevice();
	...
	{
		auto & list = driver::Device::get()->m_instanceExtensionList;
	...
	{
		auto & list = driver::Device::get()->m_deviceExtensionList;
