...
namespace vg::graphics::renderer
{
    void FiftyShadesOfGreyStyle()
    {
        ...
        colors[ImGuiCol_HeaderActive]           = ImVec4(0.35f, 0.40f, 0.95f, 1.00f);
        colors[ImGuiCol_Separator]              = ImVec4(0.13f, 0.13f, 0.14f, 0.50f);
        colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.28f, 0.32f, 0.77f, 1.00f);
        colors[ImGuiCol_SeparatorActive]        = ImVec4(0.35f, 0.40f, 0.95f, 1.00f);
        ...
        colors[ImGuiCol_TabActive]              = ImVec4(0.35f, 0.40f, 0.95f, 1.00f);
        colors[ImGuiCol_TabUnfocused]           = ImVec4(0.28f, 0.32f, 0.77f, 0.50f);
        colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.35f, 0.40f, 0.95f, 0.50f);
        colors[ImGuiCol_DockingPreview]         = ImVec4(0.25f, 0.27f, 0.29f, 1.00f);
        colors[ImGuiCol_DockingEmptyBg]         = ImVec4(0.13f, 0.13f, 0.14f, 1.00f);
