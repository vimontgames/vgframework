...
namespace vg::engine
{
    ...
    void Engine::createEditorView()
    {
        ...
        addMeshToScene("Human", "data/Models/human/human.fbx", float4(16.0f, 0.0f, 0.0f, 1.0f));
        addMeshToScene("Jess", "data/Models/jess/jess.fbx", float4(-48.0f, 0.0f, 00.0f, 1.0f));
