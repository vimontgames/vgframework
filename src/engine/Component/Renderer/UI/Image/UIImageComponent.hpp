...
namespace vg::engine
{
    VG_REGISTER_COMPONENT_CLASS(UIImageComponent, "UIImage", "Renderer", "UI Image Element", editor::style::icon::Image, getPriority(ComponentGroup::Render, ComponentPriority::Late));
