...
namespace vg::engine
{
    VG_REGISTER_COMPONENT_CLASS(UITextComponent, "UIText", "Renderer", "UI Text Element", editor::style::icon::Font, getPriority(ComponentGroup::Render, ComponentPriority::Late));
