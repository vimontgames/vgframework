...
namespace vg::renderer
{
    ...
    public:
        ...
        virtual IDebugGeometry *    CreateIndexedGeometry       (const DebugVertex * _vertices, core::u32 _vertexCount, const core::u32 * _indices, core::u32 _indexCount) = 0;
        virtual IDebugGeometry *    CreateGeometry              (const DebugVertex * _vertices, core::u32 _vertexCount) = 0;
    };
}