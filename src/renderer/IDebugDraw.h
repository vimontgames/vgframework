...
namespace vg::renderer
{
    ...
    public:
        ...
        virtual void    AddWireframeCube            (const core::IWorld * _world, const core::float3 & _minPos, const core::float3 & _maxPos, core::u32 _color, const core::float4x4 & _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
        ...
        virtual void    AddWireframeSquarePyramid   (const core::IWorld * _world, float _base, float _height, core::u32 _color, const core::float4x4 _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;

        virtual void    AddSolidCube                (const core::IWorld * _world, const core::float3 & _minPos, const core::float3 & _maxPos, core::u32 _color, const core::float4x4 & _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
        virtual void    AddSolidSphere              (const core::IWorld * _world, float _radius, core::u32 _color, const core::float4x4 _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
        virtual void    AddSolidHemisphere          (const core::IWorld * _world, float _radius, core::u32 _color, const core::float4x4 _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
        virtual void    AddSolidCylinder            (const core::IWorld * _world, float _radius, float _height, core::u32 _color, const core::float4x4 _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
        virtual void    AddSolidSquarePyramid       (const core::IWorld * _world, float _base, float _height, core::u32 _color, const core::float4x4 _matrix = core::float4x4::identity(), PickingID _pickindID = 0) = 0;
    };
}