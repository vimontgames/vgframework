...
namespace vg::renderer
{
    ...
    public:
        ...
        void    AddText         (const UICanvas * _canvas, const UIItem & _desc, const core::string & _text, Font _font, FontStyle _fontStyle, FontSize _fontSize, core::IWorld * _world) final override;
