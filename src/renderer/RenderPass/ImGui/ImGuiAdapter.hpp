...
namespace vg::renderer
{
    ...
    //--------------------------------------------------------------------------------------
    void ImGuiAdapter::setGUIThemeClassic()
    {
        ImGui::StyleColorsClassic();
    }

    //--------------------------------------------------------------------------------------
    void ImGuiAdapter::setGUIThemeDark()
    {
        ImGui::StyleColorsDark();
    }

    //--------------------------------------------------------------------------------------
    void ImGuiAdapter::setGUIThemeLight()
    {
        ImGui::StyleColorsLight();
    }

    //--------------------------------------------------------------------------------------
    void ImGuiAdapter::setGUIThemeVGDark()
    {
