...
namespace vg::renderer
{
    ...
    public:
        ...
        virtual const core::string &                GetStencilBitName                       (gfx::StencilBit _stencilBit) const = 0;
        virtual core::uint                          GetRendererOutlineCategoryCount         () const = 0;
        virtual const core::string &                GetRendererOutlineCategoryName          (OutlineCategory _category) const = 0;
    };
}