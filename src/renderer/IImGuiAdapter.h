...
namespace vg
{
    ...
    namespace renderer
    {
        ...
        public:
            ...
            virtual const ImVec4 &      GetTransientReadOnlyPropertyColor   () const = 0;
            ...
            virtual ImFont *            GetFont                             (Font _font, FontStyle _style) = 0;
            ...
            virtual void                PushFontSize                        (vg::renderer::FontSize _size) = 0;
