...
vg_enum_class_global(DisplayMode, u32,
    ...
    RayTracing_Geometry_UV1, 
    RayTracing_Geometry_VertexColor, 
    RayTracing_Geometry_VertexNormal, 
    RayTracing_Geometry_VertexTangent, 
    RayTracing_Geometry_VertexBinormal, 
