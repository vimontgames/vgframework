...
#define SCREEN_SPACE_AMBIENT_THREADGROUP_SIZE_X 16
#define SCREEN_SPACE_AMBIENT_THREADGROUP_SIZE_Y 16
...
struct ScreenSpaceAmbientConstants
{
    ...
    void setLinearDepthBuffer   (uint _depth)   { depth_normal = packUint16low(depth_normal, _depth); }
    uint getLinearDepthBuffer   ()              { return unpackUint16low(depth_normal); }
